...
This application just highlights some of the capabilities of Spring core module. It uses Spring's XML configuration.
...
Execution starts with TodoApplication.java. The main method creates an instance of ClassPathXmlApplicationContext to read
Spring configuration from spring.xml.